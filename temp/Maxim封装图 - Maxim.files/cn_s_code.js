...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,cir,ibs,txt,fam"
s.linkInternalFilters="javascript:,www.maxim-ic.com.cn"
...
s.visitorNamespace="maximintegratedproducts"
...
function s_doPlugins(s) {
	/* Add calls to plugins here */
        ...
        s.prop5=s.getAndPersistValue(s.campaign,'s_cmp_pgs',30);
...
+"'')+'://'+(s.ssl?'stats2s':'stats2')+'.maxim-ic.com/b/ss/'+s.un+'/1/H"
